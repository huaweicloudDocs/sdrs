# 创建复制对<a name="ZH-CN_TOPIC_0109214166"></a>
...
-   参数说明
    ...
    **表 1**  replication字段说明
    ...
    <p id="p3835101111314"><a name="p3835101111314"></a><a name="p3835101111314"></a>可通过接口<a href="https://support.huaweicloud.com/api-evs/zh-cn_topic_0102756196.html" target="_blank" rel="noopener noreferrer">查询所有云硬盘详情</a>获取。</p>
