# 保护实例删除网卡<a name="ZH-CN_TOPIC_0109214164"></a>
...
-   参数说明
    ...
    <p id="p1697411518219"><a name="p1697411518219"></a><a name="p1697411518219"></a>可通过<a href="https://support.huaweicloud.com/api-vpc/zh-cn_topic_0133195888.html" target="_blank" rel="noopener noreferrer">查询端口列表</a>接口获取。</p>
    </td>
    </tr>
    </tbody>
    </table>
