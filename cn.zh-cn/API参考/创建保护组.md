# 创建保护组<a name="ZH-CN_TOPIC_0109214146"></a>
...
-   参数说明
    ...
    **表 1**  server\_group字段说明
    ...
    <a name="ul349001183718"></a><a name="ul349001183718"></a><ul id="ul349001183718"><li>您可以通过“<a href="https://support.huaweicloud.com/api-vpc/zh-cn_topic_0020090608.html" target="_blank" rel="noopener noreferrer">创建VPC</a>”接口创建新的虚拟私有云。</li><li>您可以通过“<a href="https://support.huaweicloud.com/api-vpc/zh-cn_topic_0020090625.html" target="_blank" rel="noopener noreferrer">查询VPC列表</a>”接口查询虚拟私有云列表。</li></ul>
    </td>
    </tr>
