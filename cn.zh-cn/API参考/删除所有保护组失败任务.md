# 删除所有保护组失败任务<a name="ZH-CN_TOPIC_0151505104"></a>
...
-   URI格式
    ...
    DELETE /v1/\{project\_id\}/task-center/failure-jobs/batch
...
-   请求样例
    ...
    DELETE https://\{Endpoint\}/v1/\{project\_id\}/task-center/failure-jobs/batch
